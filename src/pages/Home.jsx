              ...
              <div className='grid md:grid-cols-2 gap-10'>
                {
                  ...
                  },
                  {
                    ...
                    className='bg-white border border-gray-2 rounded-3xl p-8 shadow-sm hoever:shadow-xl transition-all'
                    >
              ...
              <div className='grid md:grid-cols-2 gap-10'>
                {
                  ...
                  },
                  {
                    ...
                    className='bg-white border border-gray-200 rounded-3xl p-8 shadow-sm hoever:shadow-xl transition-all'
                    >
