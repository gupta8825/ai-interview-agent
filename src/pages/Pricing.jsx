...
const Pricing = () => {
  ...
  const plans =[
    ...
    },
    {
      ...
      price:"₹500",
      credits:650,
      description:"Best value serious job preparation.",
      feature:[
        ...
        {plans.map((plan)=>{
          ...
          return(
            ...
            className={`relative rounded-3xl p-8 transition-all duration-300 border 
              ...
              ${plan.default ? "cursor-defualt" : "cursor-pointer"}
              `}
            >

              {/* Badge */}
              {plan.badge && (
                <div className='absolute top-6 right-6 bg-emerald-600 text-white text-xs px-4
              ...
              {/* Default Tag */}
              {plan.default && (
                <div className='absolute top-6 right-6 bg-gray-200 text-gray-700 text-xs px-3
                py-1 rounded-full'>Default</div>
              )}
