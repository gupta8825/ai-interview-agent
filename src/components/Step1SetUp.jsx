      ...
      <div className="w-full max-w-6xl bg-white rounded-3xl shadow-2xl grid md:grid-cols-2 overflow-hidden">
        ...
        >
          ...
          <p className="text-gray-600 mb-10">
            Practice real interview scenarios powered by AI. Imporve
          ...
          <div className="space-y-6">
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-12 py-3 border-gray-200 rounded-xl focus:ring-2 focus:ring-green-500 outline-none transition"
              ...
              >
                ...
                {resumeFile && (
                  <motion.button
                    ...
                    className="mt-4 bg-gray-900 text-white px-5 py-2 rounded-lg hoever:bg-gray-800 transition"
                  >
            ...
            {analysisDone && (
              <motion.div
                ...
                className="bg-gray-50 borderr border-gray-200 rounded-xl p-5 space-y-4"
              >
                ...
                {projects.length > 0 && (
                  <div>
                    <p className="fontm  text-gray-700 mb-1">Projects:</p>
                ...
                {skills.length > 0 && (
                  <div>
                    <p className="fontm  text-gray-700 mb-1">Skills:</p>
