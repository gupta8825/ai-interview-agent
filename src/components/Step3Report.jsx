...
const Step3Report = ({ report }) => {
  ...
  const skills = [
    ...
    { label: "Comminication", value: communication },
  ...
  if (finalScore >= 8) {
    ...
    performanceText = "Needs minor imporvement before interviews.";
...
// draw line (visible now)
doc.setDrawColor(34, 197, 94);
doc.setLineWidth(1);

doc.line(margin, currentY, pageWidth - margin, currentY);

// move further down so box doesn't overlap
currentY += 5;
    //============================== FINAL SCORE BOX =======================================
    ...
    if (finalScore >= 8) {
      ...
      advice =
        "Significant improvement required. Focus on structuring thinking, clarity, and confident delivery. Practice answering aloud regulary.";
    }
...
doc.roundedRect(margin, currentY, contentWidth, 35, 4, 4);
  ...
  // =========================== END POINT OF DOWNLOAD SECTION(PDF)  ==================================
      ...
      <div className="mb-8 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        onClick={downloadPDF}
          className="bg-emerald-600 hover:bg-emerald-700 text-white px-6
              py-3 rounded-xl shadow-md transition-all duration-300 font-semibold text-sm sm:text-base
              text-nowrap"
        >
          Download PDF
        </button>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8">
        <div className="space-y-6">
          ...
          >
            ...
            <div className="mt-4">
              <p className="font-semibold text-gray-800 text-sm:text-base">
                {performanceText}
              </p>
          ...
          <motion.div
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            className="bg-white rounded-2xl sm:rouned-3xl shadow-lg p-6 sm:p-8"
          >
            <h3
