      ...
      >
        ...
        <div className="flex items-center gap-6 relative">
          <div className="relative">
            ...
            {showCreditPopup && (
              <div
               className="absolute right-[-50px] mt-3 w-64 bg-white shadow-xl border border-gray-200 rounded-xl p-5 z-50"
              >
          ...
          <div className="relative">
            ...
            onClick={()=>{
              ...
              className="w-9 h-9 bg-black text-white rounded-full flex items-center
            ...
            {showUserPopup && (
                <div className="absolute right-0 mt-3 w-48 bg-white shadow-xl border border-gray-200 rounded-xl p-4 z-50">
                    ...
                    <button onClick={handleLogout} className="w-full text-left text-sm py-2 flex items-center gap-2 text-red-500">Logout
